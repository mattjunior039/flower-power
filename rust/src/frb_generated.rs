...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -622020583;
...
fn wire__crate__api__crypto__decrypt_aes_cbc_zero_padding_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "decrypt_aes_cbc_zero_padding",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::crypto::decrypt_aes_cbc_zero_padding(
                        api_data, api_key, api_iv,
                    ))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        27 => wire__crate__api__crypto__decrypt_aes_cbc_zero_padding_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        28 => wire__crate__api__rar__extract_rar_archive_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__rar__extract_rar_metadata_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__epub__get_chapter_content_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__rhttp__http__make_http_request_receive_stream_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        32 => wire__crate__api__epub__parse_epub_from_bytes_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__epub__parse_epub_from_path_impl(port, ptr, rust_vec_len, data_len),
        34 => {
            wire__crate__api__rhttp__http__register_client_impl(port, ptr, rust_vec_len, data_len)
        }
        36 => wire__crate__api__aidoku_wasm__set_aidoku_default_setting_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        35 => wire__crate__api__rhttp__http__register_client_sync_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
