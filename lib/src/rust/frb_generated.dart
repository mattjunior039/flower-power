...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -622020583;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<Uint8List> crateApiCryptoDecryptAesCbcZeroPadding({
  ...
  Future<Uint8List> crateApiCryptoDecryptAesCbcZeroPadding({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiCryptoDecryptAesCbcZeroPaddingConstMeta,
        argValues: [data, key, iv],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiCryptoDecryptAesCbcZeroPaddingConstMeta =>
      const TaskConstMeta(
        debugName: "decrypt_aes_cbc_zero_padding",
        argNames: ["data", "key", "iv"],
      );
