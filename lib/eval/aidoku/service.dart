...
import 'package:flower_power/eval/aidoku/aidoku_ext_dart.dart' as aidoku;
import 'package:flower_power/eval/interface.dart';
import 'package:flower_power/eval/model/filter.dart' as m_filter;
import 'package:flower_power/eval/model/m_chapter.dart';
...
import 'package:flower_power/src/rust/api/aidoku_wasm.dart' as rust;
...
class AidokuExtensionService implements ExtensionService {
  ...
  Future<MPages> search(String query, int page, List<dynamic> filters) async {
    final s = await _ensureInitialized();
    final filterValues = _mapFlowerPowerFiltersToAidoku(filters);
  ...
  List<aidoku.FilterValue> _mapFlowerPowerFiltersToAidoku(List<dynamic> filters) {
