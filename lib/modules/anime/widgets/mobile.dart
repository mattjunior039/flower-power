...
import 'package:flower_power/modules/anime/widgets/custom_seekbar.dart';
import 'package:flower_power/modules/anime/widgets/indicator_builder.dart';
                                    ...
                                    children: [
                                      StreamBuilder<bool>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return IconButton(
                                            iconSize: (MediaQuery.of(context).size.width * 0.1).clamp(48.0, 100.0),
                                            icon: Icon(
