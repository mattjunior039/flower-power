...
import 'package:flower_power/modules/browse/providers/browse_initial_tab_provider.dart';
import 'package:flower_power/models/settings.dart';
import 'package:flower_power/modules/more/data_and_storage/widgets/unified_restore.dart';
...
import 'package:flower_power/utils/local_directory_access.dart';
...
/// FlowerPower ships with no sources of its own and that supplying them is the
...
class _OnboardingScreenState extends ConsumerState<_OnboardingBody>
  ...
  /// steps first and find Settings afterwards. FlowerPower's own backups and
  ...
  Future<void> _restore() async {
    ...
    // FlowerPower backup carries the repositories, but only when its settings
    // were included in it, and a Mihon, Aniyomi or Neko backup references its
    // own ecosystem's extensions and never carries FlowerPower repositories.
    //
