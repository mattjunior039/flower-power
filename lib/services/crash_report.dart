...
bool isExtensionFailure(Object error, {String? source, String? stack}) {
  ...
  return source == 'updateMangaDetail' ||
      stackText.contains('package:flower_power/eval/') ||
...
/// Whether this report belongs in FlowerPower's issue tracker.
///
/// Network/image failures need retry or source-specific help, while extension
/// failures belong to the extension. Offering either a FlowerPower bug button
